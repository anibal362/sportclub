...
<div id="page-wrapper">
	...
	<div class="container">
		<section id="contentt">
			<form action="">
				<br><h1 style="color:#277CD5;font-size:25px">Inscribirse</h1><br>
				<center>
					<div>
						<input type="text" placeholder="Nombre Completo" required id="nameevent" />
					</div>
					<div>
						<input type="text" placeholder="E-mail" required id="email" />
					</div>
					<div>
						<input type="text" placeholder="Teléfono" required id="number" />
					</div>
				</center>
				<div>
					<br><input type="submit" value="Participar"/><br>
					<a href="iniciar.jsp" style="font-size:15px"><strong>Iniciar Sesión</strong></a>
				</div>
			</form><!-- form -->
			<br>
		</section><!-- content -->
